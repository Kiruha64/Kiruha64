...
{{-- Your code--}}
                ...
                <div class="container"
                    ...
                    <div class="row">
                        <form method="POST" action="{{ route('blocks-create-post') }}"enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="input-lg col-md-10"name="short_description"placeholder="short_description" style="border: 2px solid gray">
                            </div>

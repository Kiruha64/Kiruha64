        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                @foreach($pages as $page)
                    <tr class="odd gradeX">
                        <td><nobr>{{ $page->id }}</nobr></td>
                        <td><nobr>{{ $page->title }}</nobr></td>
                        <td><nobr>{{ $page->alias }}</nobr></td>
                        <td><nobr>{{ $page->position }}</nobr></td>
                        <td><nobr>{{ $page->is_visible }}</nobr></td>
                        <td><nobr>{{ $page->created_at }}</nobr></td>
                        <td><nobr>{{ $page->updated_at }}</nobr></td>
                        ...
                        <td class="text-center"><a href="{{ route('update-pages', $page->id) }}"><button class="btn btn-primary"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        <td class="text-center"><a href="{{ route('delete-pages', $page->id) }}"><button class="btn btn-danger "> <i class="fa fa-trash-o" aria-hidden="true"></i> </button></a></td>

...
{{-- Your code--}}
        <div class="container"
            ...
            <div class="row">
                <form method="POST" action="{{route('post-update-pages', $data->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="input-lg col-md-10"   value="{{ $data->title }}"  name="title"placeholder="title" style="border: 2px solid gray">
                    </div>

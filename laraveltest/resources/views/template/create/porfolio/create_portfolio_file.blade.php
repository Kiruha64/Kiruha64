...
{{-- Your code--}}
                ...
                <div class="container"
                    ...
                    <div class="row">
                        <form method="POST" action="/Portfoliofileaction"enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="input-lg col-md-10"name="name"placeholder="name" style="border: 2px solid gray">
                            </div>

...
<div class="container"
    ...
    <div class="row">
        <form method="POST" action="{{ route('secondslider-create-post') }}"enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <h4><strong>Title Link</strong></h4>
                <input type="text" class="input-sm col-md-10 "name="link_title" placeholder="title_link" style="border: 2px solid gray">
            </div>

            <div class="col-md-12">
                <h4><strong>Link</strong></h4>
                <input type="text" class="input-sm col-md-10 "name="link" placeholder="link" style="border: 2px solid gray">
            </div>

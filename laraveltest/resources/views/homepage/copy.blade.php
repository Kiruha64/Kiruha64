        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#">Штучний інтелект</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#About">Загально</a>
                </li>
                <li class="nav-item">
...
<div id="myCarousel" class="carousel slide " data-ride="carousel">
    ...
    <div class="carousel-inner"style="background-color: #2B2B2B">



        <div class="carousel-item active ">
            <img src="https://www.smileexpo.com.ua/public/upload/news/gotovie_ai_resheniya_v_kakih_sferah_iskusstvenniy_intellekt__15416868437124_image.jpg" class="text-center" width="100%" height="500px"  >
            <div class="container">
                <div class="carousel-caption text-left">
                    <h1 style="color:#EA586F" >Штучний інтелект</h1>
                    <p >Розділ комп'ютерної лінгвістики та інформатики, що опікується формалізацією проблем та завдань, які подібні до дій, які виконує людина</p>
                    <p><a class="btn btn-lg btn-warning" href="https://uk.wikipedia.org/wiki/%D0%A8%D1%82%D1%83%D1%87%D0%BD%D0%B8%D0%B9_%D1%96%D0%BD%D1%82%D0%B5%D0%BB%D0%B5%D0%BA%D1%82" role="button">Читати більше</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item" >
            <img src="https://www.everest.ua/wp-content/uploads/2018/06/%D0%A8%D1%82%D1%83%D1%87%D0%BD%D0%B8%D0%B9-%D1%96%D0%BD%D1%82%D0%B5%D0%BB%D0%B5%D0%BA%D1%82-%D0%90%D0%86.jpg" class="" width="100%" height="500px"  >
            <div class="container">
                <div class="carousel-caption text-center">
                    <h1 style="color:#EA586F">Загальний опис</h1>
                    <p style="color:#EA586F">У більшості випадків алгоритм розв'язання завдання невідомий наперед. Точного визначення цієї науки немає, оскільки у філософії не розв'язано питання про природу і статус людського інтелекту.</p>
        ...
        <div class="carousel-item"style="max-height: 500px">https://uagolos.com/wp-content/uploads/2018/06/858x540-620x330.jpg   https://images.unian.net/photos/2019_01/1548421719-5129.jpg?0.5906592526824366
...
<div class="container-fluid">
    <div id="About" class="content row">
        ...
        <div id="About1" class="col-md-3 col-sm-12 text-center">
            <img style="border-radius: 6%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRxPsyZ-ttmLG_hltqUdN8ER8JBVHd5-7yCWf8No802UPSTwA7y" id="" class="img-about"></br>
            <a href="#" id=""  class="a-about"><b>Підходи</b></a></br>
            <p id="" >Штучний інтелект вивчає методи розв'язання завдань, які потребують людського розуміння. Отже, мова іде про те, щоби навчити ШІ розв'язувати тести інтелекту. Це передбачає розвиток способів розв'язання задач за аналогією, методів дедукції та індукції, накопичення базових знань і вміння їх використовувати.</p>
...
<h1 class="h1-zagolovok content text-center" id="service">Вивчення</h1><br>
    ...
    <div class="row">
        <div>
            <div class="col-md-4 col-sm-12 "style="float: left">
                <img style="border-radius: 6%" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSb_bD5BooGCuxgVzrcpqjblaf4byr0efiq3-WhvEDnzBaRjUEt" class="services-img "width="50px"height="50px">
                <a class="services-link align-top">Підходи до вивчення</a>
                <p class="services-p  text-center">Існують різні методи створення систем штучного інтелекту. У наш час можна виділити 4 досить різних методи:</p>
            </div>
...
<div id="Portfolio" class="content">
    ...
    <div id="but-port"class="content row">
        <div class="col-md-12 text-center">
            ...
            <button class="button col-md-2 col-sm-12"id="button2">Мозок</button>
...
<p><h1 class="h1-zagolovok  content" id="features-martop">Детально</h1></p>

<div class="container-fluid">
    <div class="row">
        <div class="text-center col-md-4 col-sm-12" style="float: right">
            <img  style="border-radius: 6%" src="http://www.morpheos.eu/wp-content/uploads/2018/08/blog-rubrica-ai.png" class="features-img" width="50px"height="50px"><br>
            <a href="#" class="featuresa"><h1 class="align-top featuresh1" >Теоретичні положення</h1></a>
            <p class="featuresp">Кінцевою метою досліджень з питань «штучного інтелекту» є розкриття таємниць мислення та створення моделі мозку. Принципова можливість моделювання інтелектуальних процесів випливає з основного гносеологічного результату кібернетики, який полягає у тому, що будь-яку функцію мозку, будь-яку розумову діяльність.</p>
        </div>
...
<p><h1 class="h1-zagolovok  content mt-5" id="">Statistic table</h1></p>

<div class="container-fluid"id="stat_table" >
    <div class="row">
...
<h1 class="h1-zagolovok content" id="overflow">Родні Брукс</h1>

<div class="container-fluid content"id="all-our-team">
    <div class="row">

        <div class="col-sm-12 col-12 col-md-4  text-center mt-3" id="our-team1">


            <div id="our-team-opacity1">
...
<div class="container-fluid content">
    <div class="row text-center">
        ...
        <div class="col-md-3 col-sm-12 text-center mt-3" id="pricing_1table">

            <h3 class="pricing_h3 mt-3">ШІ</h3>

            <b class="pricing_b1 mt-3">Переваги</b></br>

            <b class="pricing_b2 mt-3">Штучного інтелекту</b>


            <p class="pricing_p mt-3"> &#10004 ШІ перемагає людину в змаганнях</p>
            <p class="pricing_p mt-3"> &#10004 Читає думки</p>
            <p class="pricing_p mt-3"> &#10004 Керує автомобілем</p>
            <p class="pricing_p mt-3"> &#10004 Спілкується з людьми в чатах і звільняє співробітників за незадовільну роботу.</p>

            <a href="https://uk.wikipedia.org/wiki/%D0%A8%D1%82%D1%83%D1%87%D0%BD%D0%B8%D0%B9_%D1%96%D0%BD%D1%82%D0%B5%D0%BB%D0%B5%D0%BA%D1%82"><button class="pricing_btn  mt-3 mb-3"id="">ШІ</button></a>


        </div>

        <div class="col-md-6 col-sm-12 text-center mt-3" id="pricing_2table">
        ...
        <div class="col-md-3 col-sm-12 text-center mt-3" id="pricing_3table">
...
<div id="myCarousel2" class="carousel slide  mt-5" data-ride="carousel" style="color: #0f0f0f">
    ...
    <div class="carousel-inner"style=" background-image: url(img/logotup/2.jpg);background-size: cover;">
        ...
        <div class="carousel-item active">
            ...
            <div class="container">
                <div class="carousel-caption text-center">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/HONDA_ASIMO.jpg/375px-HONDA_ASIMO.jpg" class="slider2img mt-4 col-md-3  col-5">
                    <p><i class="fa fa-user"> </i> <a href="https://uk.wikipedia.org/wiki/ASIMO">ASIMO </a></p>
                    <p>Є гуманоїдним роботом створеним Honda Motor Company. За офіційною версією ім'я робота є акронімом від англ. «Advanced Step in Innovative MObility».</p>
        ...
        <div class="carousel-item">
            ...
            <div class="container">
                <div class="carousel-caption text-center">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Kismet_robot_20051016.jpg/500px-Kismet_robot_20051016.jpg" class="slider2img mt-4 col-md-3  col-5">
                    <p><i class="fa fa-user"> </i> Робот <a href="#"> Кісмет</a></p>
                    <p>Робот був створений в кінці 1990-х.Слухові, візуальні і виразні системи робота були призначені для його участі в соціальній взаємодії з людиною і моделюванні людських емоцій і міміки.</p>
        ...
        <div class="carousel-item">
            ...
            <div class="container">
                <div class="carousel-caption text-center">
                    <img src="{{asset('img/humanbc/img3.jpg')}}" class="slider2img col-md-3  col-5">
    ...
    <h1 id="form-marg" class="h1-zagolovok content col-sm-12">Напишіть нам</h1>
            ...
            <div class="row">
                ...
                <div class="mb-4 "id="" >
                    ...
                    <div class="col-sm-12 col-md-3  mt-4" style="float: left"id="sotsseti">
                        <h1 class="footer_h1">Чи може машина мислити?</h1>
                        <p class="text-left">
                            Питання «Чи може машина мислити?», яке підштовхнуло дослідників до створення науки про моделювання людського розуму, було поставлено Аланом Тюрінгом у 1950 р. Дві основних точки зору на це питання носять назви гіпотез сильного і слабкого штучного інтелекту.
                        </p>

                        <a href="https://www.instagram.com/kiruha_64/?hl=ru" class="share-button share-via-facebook">
                            <i class="fa fa-facebook" id="change-color1"></i>

                        </a>
                        <a href="https://www.instagram.com/kiruha_64/?hl=ru" class="share-button share-via-twitter">
                            <i class="fa fa-twitter"id="change-color2"></i>

                        </a>


                        <a href="https://www.instagram.com/kiruha_64/?hl=ru"
                           class="share-button share-via-linkedin" >
                            <i class="fa fa-linkedin"id="change-color3"></i>
                        </a>


                        <a href="https://www.instagram.com/kiruha_64/?hl=ru" class="share-button share-via-google-plus">
                            <i class="fa fa-google-plus"id="change-color4"></i></a>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3 mt-4 text-center" style="float: left">
                        ...
                        <a href="#"><button class="mt-3 mb-2 btn col-md-6 float-left"id="footer_btn"><b>Відправити</b></button></a>
                    </div>
            ...
            <div class="row">
                <div class="" id="" >
                    ...
                    <div  class="col-md-12 text-center ">
                        ...
                        <a href="#" class="footer_last_a col-md-3 col-sm-12">Штучний інтелект</a>
                        <a href="#" class="footer_last_a col-md-3 col-sm-12">На верх</a>
                        <a href="https://www.instagram.com/kiruha_64/?hl=ru" CLASS="col-sm-3">Про нас</a>
                        <a href="#" class="footer_last_a col-md-3 col-sm-12">Вивчення</a>
                        <br>
